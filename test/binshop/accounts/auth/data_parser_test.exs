defmodule Binshop.Accounts.Auth.DataParserTest do
  use Binshop.DataCase, async: true

  alias Binshop.Accounts.Auth.DataParser

  describe "ueberauth_data/1 from google" do
    test "should return unified data for user" do
      test_data = %{
        ...
        extra: %{
          raw_info: %{
            ...
            user: %{
              "email" => "ueberauth_test_email@testgoogle.test",
              "email_verified" => true,
              "hd" => "binario.dev",
        ...
        info: %{
          ...
          image: "http://test_picture_url.testgoogle.test",
      ...
      assert %{
               ...
               last_name: last_name
             } = DataParser.ueberauth_data(test_data)

      assert email == "ueberauth_test_email@testgoogle.test"
      assert picture == "http://test_picture_url.testgoogle.test"
      assert first_name == "test_google_first_name"
      assert last_name == "test_google_last_name"
    end
  end
end
